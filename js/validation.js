...
const request = 'https://www.thecocktaildb.com/api/json/v1/1/filter.php?a=Alcoholic'
var response 
fetch (request)
.then((res) => {
    ...
    .then((data) => {      
        ...
        for (var i = 0; i < itemList.length; i++){
            for (var ii = 0; ii < data['drinks'].length; ii++){
                var option = document.createElement("option")
                var optionTextNode = document.createTextNode(data['drinks'][ii]['strDrink'])
                option.value = data['drinks'][ii]['strDrink']
